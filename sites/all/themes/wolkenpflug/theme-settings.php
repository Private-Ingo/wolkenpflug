 ...
 */
function wolkenpflug_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['wolkenpflug_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('wolkenpflug Theme Settings'),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
  );

  $form['wolkenpflug_settings']['breadcrumbs'] = array(
    '#type' => 'checkbox',
  ...
  $form['wolkenpflug_settings']['general_settings']['wolkenpflug_themelogo'] = array(
    '#type' => 'checkbox',
    '#title' => t('Use theme Logo?'),
    '#default_value' => theme_get_setting('wolkenpflug_themelogo'),
    '#description' => t("Check for yes, uncheck to upload your own logo!"),
  );

  $form['wolkenpflug_settings']['general_settings']['theme_bg_config']['theme_bg'] = array(
    '#type' => 'select',
  ...
  $form['wolkenpflug_settings']['general_settings']['theme_color_config']['theme_color_palette'] = array(
    '#type' => 'select',
    '#title' => t('Choose a color palette'),
    '#default_value' => theme_get_setting('theme_color_palette'),
    '#options' => array(
      'green_wolkenpflug' => t('Green wolkenpflug'),
      'warm_purple' => t('Warm purple'),
      'dark_rust' => t('Dark rust'),
    ),
  );

  $form['wolkenpflug_settings']['general_settings']['header_font_style'] = array(
    '#type' => 'select',
  ...
  $form['wolkenpflug_settings']['general_settings']['body_font_style'] = array(
    '#type' => 'select',
  ...
  $form['wolkenpflug_settings']['general_settings']['theme_sidebar_location'] = array(
    '#type' => 'select',
  ...
  $form['additional_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('Additional wolkenpflug Settings'),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
  );

  $form['additional_settings']['other_settings']['wolkenpflug_localcss'] = array(
    '#type' => 'checkbox',
    '#title' => t('Use local.css?'),
    '#default_value' => theme_get_setting('wolkenpflug_localcss'),
    '#description' => t("This setting allows you to use your own custom css file within the wolkenpflug
  ...
  $form['additional_settings']['other_settings']['wolkenpflug_tertiarymenu'] = array(
    '#type' => 'checkbox',
    '#title' => t('Use tertiary drop down menus?'),
    '#default_value' => theme_get_setting('wolkenpflug_tertiarymenu'),
    '#description' => t("Check this box if you are going to have tertiary (third level drop down menus)"),
  );

  $form['additional_settings']['other_settings']['wolkenpflug_viewport'] = array(
    '#type' => 'checkbox',
    '#title' => t('Use Touch device pinch and zoom?'),
    '#default_value' => theme_get_setting('wolkenpflug_viewport'),
  ...
  $form['additional_settings']['other_settings']['wolkenpflug_imagecaptions'] = array(
    '#type' => 'checkbox',
    '#title' => t('Use Image Captions?'),
    '#default_value' => theme_get_setting('wolkenpflug_imagecaptions'),
    '#description' => t("Check this box if you would like captions for imagefield images."),
  );

  $form['additional_settings']['other_settings']['wolkenpflug_tablehover'] = array(
    '#type' => 'checkbox',
    '#title' => t('Use experimental table hover effect?'),
    '#default_value' => theme_get_setting('wolkenpflug_tablehover'),
  ...
  $form['custom_css_path_settings']['custom_css_path']['wolkenpflug_custom_css_location'] = array(
    '#type' => 'checkbox',
    '#title' => t('Only check the box if you want to specify a custom path below to your local css file.'),
    '#default_value' => theme_get_setting('wolkenpflug_custom_css_location'),
  );

  $form['custom_css_path_settings']['custom_css_path']['wolkenpflug_custom_css_path'] = array(
    '#type' => 'textfield',
    ...
    '#default_value' => theme_get_setting('wolkenpflug_custom_css_path'),
  );
